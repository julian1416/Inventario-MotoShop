  ...
  return [
    {
      ...
      description: "Casco integral con certificación DOT, visera antirrayones y excelente ventilación.",
      hasVariants: true,
      variants: [
        {
          id: "var-1-1",
    ...
    },
    {
      ...
      description: "Casco liviano de protección infantil con almohadillas acolchadas y broche micrométrico.",
      hasVariants: true,
      variants: [
        {
          id: "var-kid-1",
    ...
    },
    {
      ...
      type: "Pistera",
      measure: "130/70-17",
      description: "Llanta deportiva de excelente agarre en mojado gracias a la tecnología de laminillas Michelin XST Evo.",
      hasVariants: false,
      singleQuantity: 12,
      createdAt: now,
      updatedAt: now
    },
    {
      ...
      measure: "110/80-R19",
      description: "Llanta ideal para motos Trail que buscan un excelente rendimiento 80% on-road y 20% off-road.",
      hasVariants: false,
      singleQuantity: 7,
      createdAt: now,
      updatedAt: now
    },
    {
      ...
      brand: "Shaft",
      category: "Cascos Adultos",
      description: "Casco abatible con doble visor, ideal para recorridos urbanos y de carretera.",
      hasVariants: true,
      variants: [
        {
          id: "var-4-1",
    ...
    },
    {
      ...
      brand: "Givi",
      category: "Maleteros",
      description: "Maleta trasera de 30 litros de capacidad con sistema de anclaje rápido Monolock. Incluye base universal.",
      hasVariants: false,
      singleQuantity: 5,
      createdAt: now,
      updatedAt: now
    },
    {
      ...
      brand: "Promecol",
      category: "Parrillas",
      description: "Soporte trasero reforzado de alta resistencia, fabricado en acero estructural.",
      hasVariants: false,
      singleQuantity: 10,
      createdAt: now,
      updatedAt: now
    },
    {
      ...
      brand: "Fire Parts",
      category: "Lujos",
      description: "Protectores laterales contra caídas con punteras reemplazables de diseño carbono.",
      hasVariants: false,
      singleQuantity: 15,
      createdAt: now,
      updatedAt: now
    },
    {
      ...
      brand: "Vnetphone",
      category: "Accesorios",
      description: "Intercomunicador Bluetooth para casco, alcance de 1200 metros, conexión hasta 6 pilotos.",
      hasVariants: false,
      singleQuantity: 9,
      createdAt: now,
      updatedAt: now
